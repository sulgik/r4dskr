...
```{r tidy-structure, echo = FALSE, out.width = "100%", fig.cap = "데이터셋을 타이디하게 만드는 세 가지 규칙: 변수는 열에 있고, 관측값은 행에 있고, 값은 셀에 있다."}
knitr::include_graphics("images/tidy-1kr.png")
```
...
```{r tidy-pivot-longer, echo = FALSE, out.width = "100%", fig.cap = "`table4` 을 더 긴  타이티 형태로 피봇팅하기"}
...
```{r tidy-pivot-wider, echo = FALSE, out.width = "100%", fig.cap = "`table2` 을 더 넓은 타이티 형태로 피봇팅하기"}
