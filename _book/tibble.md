...
`data.frame()` 에 비해 `tibble()` 은 동작의 규모가 훨씬 작다는 것에 주의해야 한다. 즉, 입력의 유형을 절대로 변경하지 않고 (예를 들어, 문자열을 팩터형으로 변환하지 않는다!), 변수의 이름을 바꾸거나, 행 이름을 생성하지 않는다.
...
#> 1 2021-12-03 23:26:56 2021-12-10     1 0.368 n    
#> 2 2021-12-04 17:32:06 2021-12-15     2 0.612 l    
#> 3 2021-12-04 11:55:45 2021-12-25     3 0.415 p    
#> 4 2021-12-04 01:17:02 2021-12-24     4 0.212 m    
#> 5 2021-12-03 21:41:19 2021-12-21     5 0.733 i    
#> 6 2021-12-04 08:42:16 2021-12-17     6 0.460 n    
#> # … with 994 more rows
```
